...
export default async function BlogArchivePage({
  ...
  const archive = await getBlogArchivePage(requestedPage, PAGE_SIZE)
  const currentPage = archive.page
    ...
    <main className="min-h-screen text-white pt-24">
      <section className="py-16 px-6">
        <div className="max-w-6xl mx-auto">
          ...
          <p className="mt-4 text-xl text-gray-400 max-w-2xl">
            ...
            {currentPage > 1 ? ` Page ${currentPage} of ${totalPages}.` : null}
          </p>
        </div>
      </section>
      ...
      <section className="py-12 px-6">
        <div className="max-w-4xl mx-auto">
          {articles.length === 0 ? (
            <p className="text-gray-400 text-center py-12">No archive posts yet.</p>
          ) : (
              ...
              {articles.map((article) => (
                ...
                >
                  <div className="flex flex-col md:flex-row">
                    <div
                      className="w-full md:w-48 h-32 md:h-auto bg-cover bg-center flex-shrink-0 bg-gray-800"
                    ...
                    <div className="flex-1 p-6 flex flex-col md:flex-row md:items-center md:justify-between gap-4">
                      <div className="flex-1">
                        ...
                        <h3 className="text-xl font-semibold group-hover:text-green-400 transition">{article.title}</h3>
